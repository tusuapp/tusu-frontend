  ...
  return (
    <>
      <Seo
        ...
        description="Create your free Tusu student account to find expert tutors, book 1-on-1 online classes and start learning your way."
        canonical="/signup/student"
      />
      <Header />
