...
const makePayment = async (
    ...
    try {
        // const response = await api.post(`/student/make-payment/${cartId}`, {
        //   selected_gateway: 1,
        //   notes,
        // });

        // const redirect_url = response.data.result.checkout_url;
                                            ...
                                            <div className="col-lg-5">
                                                <div className="row justify-content-start">
                                                    ...
                                                    <div className="p-0">
                                                        ...
                                                        <br/>
                                                        <span
                                                            style={{color: "#924781", fontWeight: 500}}
                                                        >
                                Note:
                              </span>{" "}
