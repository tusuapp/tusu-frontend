...
function TutorProfile() {
    ...
    const fetchAvailableSchedules = async (date: string) => {
        try {
            ...
            return response.data.result.times;
        } catch (e: any) {
                    ...
                    />
                                ...
                                <div>
                                    <ReactPlayer
                                        ...
                                        height="100%"
                                        controls
                                        url={profile.video ? process.env.NEXT_PUBLIC_API_ENDPOINT + profile?.video.slice(1, profile?.video.length) : ""}
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            ...
                                            <div className="Student-profile__right_column__choosen__class__details">
                                                <div className="col-md-4">
                                                    <div
                                                        className="Student-profile__right_column__choosen__class__details__subject">
                                                ...
                                                <div className="col-md-8">
                                                    <div
                                                        className="Student-profile__right_column__choosen__class__details__schedule p-3">
